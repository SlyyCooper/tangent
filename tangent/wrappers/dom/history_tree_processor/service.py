...
from tangent.wrappers.dom.history_tree_processor.view import DOMHistoryElement, HashedDomElement
from tangent.wrappers.dom.history_tree_processor.view import DOMElementNode
